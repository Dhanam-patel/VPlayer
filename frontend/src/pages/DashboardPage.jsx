				...
				{!isStreaming && !analysisData && (
					<div className="flex h-full min-h-[420px] flex-col items-center justify-center text-center">
						...
						<p className="mt-2 max-w-xl text-sm text-slate-300">
							Fill in your story details and hit{" "}
							<span className="font-semibold text-cyan-200">
								Run Episodic Analysis
							</span>{" "}
							to generate a full episode blueprint with scripts, emotional arcs,
					...
					<div className="min-h-[420px] space-y-5">
						...
						<div className="rounded-xl border border-white/10 bg-black/30 p-4">
							...
							<div className="max-h-[360px] space-y-3 overflow-auto">
								{/* Node insights — structured reasoning/feedback from pipeline nodes */}
								{Object.keys(nodeInsights).length > 0 &&
									Object.entries(nodeInsights).map(([field, insight]) => (
										<div
											key={field}
								...
								{/* Original thinking stream — backward compatible */}
								{rawThoughts ? (
								...
								{Object.keys(nodeInsights).length === 0 && !rawThoughts && (
